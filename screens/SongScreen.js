import { View, Text, TextInput, TouchableOpacity, Keyboard, Image, Modal, Pressable } from 'react-native'
    ...
    return (
        <>
            <View className="px-6 bg-white flex-1">
                ...
                <ScrollView showsVerticalScrollIndicator={false} className="mt-3 space-y-2">
                            ...
                            categories.map((category, index) => {
                                return (
                                    <View style={{ width: '48.4%', height: 120 }} key={index} className="relative bg-white mb-3 rounded-xl">
                                        <Image style={{ width: '100%', height: '100%' }} source={category.image} className="rounded-xl opacity-90"></Image>
            ...
            {isFocused && (
                <Animated.ScrollView
                    ...
                    className="absolute bg-white top-16 bottom-0">
                        ...
                        searchHistories.map((history, index) => (
                            <>
                                <Pressable key={index} onLongPress={()=>onLongPress(index)} onPressOut={onLongPressEnd} onPress={() => { console.log(index) }}>
                                    <React.Fragment>
                                        <Animated.View style={indexToAnimate===index?animatedStyle:undefined}>
                                            <View style={{ width: '100%' }} className="flex-row items-center w-100 px-6 py-3">
                                                <Image
